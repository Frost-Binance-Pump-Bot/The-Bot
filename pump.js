  ...
  binance.exchangeInfo(function (error, data) {
    ...
    rl.question('[                   ]: ', function (line) {
	  ...
	  console.log(chalk.red.bold('PLEASE CHECK TRADING PAIR!'))
        ...
        console.info("")
        console.log(chalk.yellow.bold('1', chalk.underline.bgBlue(' - SELL ALL')))
        console.log(chalk.yellow.bold('2', chalk.underline.bgBlue(' - SELL HALF')))
        console.log(chalk.yellow.bold('3', chalk.underline.bgBlue(' - SELL QUARTER')))
        console.log(chalk.yellow.bold('4', chalk.underline.bgBlue(' - SELL 10%')))
        console.log(chalk.yellow.bold('5', chalk.underline.bgBlue(' - BUY ALL')))
        console.log(chalk.yellow.bold('6', chalk.underline.bgBlue(' - BUY HALF')))
        console.log(chalk.yellow.bold('7', chalk.underline.bgBlue(' - BUY QUARTER')))
        console.info("")
