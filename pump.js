...
function start() {
  binance.exchangeInfo(function (error, data) {
    ...
    console.info("")
    console.info("")
    console.log(chalk.black.bold.bgYellow('BINANCE P   BINANCE PRO BI   CE PR          PRO BINAN    RO BIN NCE PRO'))
    console.log(chalk.black.bold.bgYellow('BI    E PR    NAN   PRO BIN  CE PR        E PRO BINANC   RO BIN NCE PRO'))
    console.log(chalk.black.bold.bgYellow('BI      PRO   NAN   PRO BINA CE PR       CE PRO BINANCE  RO BIN NCE PRO'))
    console.log(chalk.black.bold.bgYellow('BIN NCE P     NAN   PRO   NANCE PR      NCE PRO BIN  CE PRO BIN NCE PRO'))
    console.log(chalk.black.bold.bgYellow('BIN NCE PR    NAN   PRO    ANCE PR     A        BIN   E PRO BIN NCE PRO'))
    console.log(chalk.black.bold.bgYellow('BI      PRO   NAN   PRO    ANCE PR    NANCE PRO BIN      RO BIN NCE PRO'))
    console.log(chalk.black.bold.bgYellow('BI    E PR    NAN   PRO     NCE PR   INANCE PRO BIN       O BIN NCE PRO'))
    console.log(chalk.black.bold.bgYellow('BINANCE P   BINANCE PRO      CE PR  BINANCE PRO BIN         BIN NCE PRO'))
    ...
    rl.question('[                   ]: ', function (line) {
	  ...
	  console.log(chalk.black.bold.bgRed('PLEASE CHECK TRADING PAIR!'))
        ...
        console.log(chalk.cyan.bold('m  - ', chalk.black.bold.bgYellow(' Toggle Manual(manual sell & buy [no take profit or stop loss]) ')))
        console.info("")
